...
procedure TFormTrabalhadores.btn_fecharClick(Sender: TObject);
begin
  pnlAdcTrabalhador.Visible:= False;
end;

procedure TFormTrabalhadores.btn_fecharMouseEnter(Sender: TObject);
begin
  btn_fechar.Color:= clRed;
  btn_fechar.Font.Color:= clWhite;
end;

procedure TFormTrabalhadores.btn_fecharMouseLeave(Sender: TObject);
begin
  btn_fechar.Color:= clWhite;
  btn_fechar.Font.Color:= clBlack;
end;

procedure TFormTrabalhadores.edNomeChange(Sender: TObject);
begin
